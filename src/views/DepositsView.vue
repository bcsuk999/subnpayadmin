<template>
  <section class="page">
    ...
    <div class="card">
      <div class="card-head">
        <h3>Deposit queue</h3>
        <button class="btn btn-primary" type="button" @click="toast.info('Fetch deposits API coming soon')">Refresh</button>
      </div>
      <p class="empty">No deposits to display. Hook to <code>GET /api/admin/deposits</code> when ready.</p>
    </div>
  </section>
</template>
