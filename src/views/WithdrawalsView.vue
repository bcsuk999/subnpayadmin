  ...
  <section class="page">
    ...
    <div class="card">
      <div class="card-head">
        ...
        <button class="btn btn-primary" type="button" @click="toast.info('Fetch withdrawals API coming soon')">Refresh</button>
      </div>
      <p class="empty">No withdrawals to display. Hook to <code>GET /api/admin/withdrawals</code> when ready.</p>
    </div>
  </section>
</template>
