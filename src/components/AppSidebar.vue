...
const navItems = [
  ...
  { label: 'Payouts', to: '/payouts', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><rect x="2" y="4" width="20" height="16" rx="2" stroke="currentColor" stroke-width="1.5"/><path d="M2 8h20" stroke="currentColor" stroke-width="1.3"/><path d="M6 12h4M6 15h8" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"/></svg>' },
]
</script>
